...
type ServerInterface interface {
	...
	GetRepository(w http.ResponseWriter, r *http.Request, owner string, repo string)
}
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/api/v1/repos/{owner}/{repo}", wrapper.GetRepository)
...
type GetRepository200JSONResponse RepositoryResponse
...
type GetRepository400Response struct {
}

func (response GetRepository400Response) VisitGetRepositoryResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type GetRepository500Response struct {
}

func (response GetRepository500Response) VisitGetRepositoryResponse(w http.ResponseWriter) error {
	w.WriteHeader(500)
	return nil
}
...
// GetRepository operation middleware
func (sh *strictHandler) GetRepository(w http.ResponseWriter, r *http.Request, owner string, repo string) {
